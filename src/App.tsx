    ...
    <>
      {!IsLoading ? (
        ...
        >
          ...
          <div className={`text-7xl font-semibold text-center py-3`}>
...
function ShowCurr({
  ...
  return (
    <div
      className={`flex justify-between items-stretch text-${color} bg-${color}/5 border border-${color}/5 rounded-xl px-3 py-2`}
    >
      <div className=" grid">
        <div className={`text-xs opacity-70 pt-1}`}>{title}</div>
